...
@section('content')
<div class="container">
    <h2 class="mb-4">Generar Desprendible</h2>
    ...
    <form action="{{ route('desprendible.pdf') }}" method="POST" target="_blank">
        @csrf
        ...
        <button type="submit" class="btn btn-primary">Generar Desprendible</button>
    </form>
